...
const Dashboard = () => {
  ...
  return (
    <div className="p-6 md:p-8 max-w-7xl mx-auto space-y-8">
      ...
      {/* TOAST NOTIFICATION */}
      {toast.show && (
        <div className="fixed bottom-6 right-6 z-50 bg-gray-900 text-white px-4 py-3 rounded-xl shadow-xl flex items-center space-x-2 animate-fadeIn">
